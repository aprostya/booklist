...
<FieldArray name="hello" component={books =>
  <ul>
    <div>
      <label>Авторы</label>
      <li>
...
const FieldLevelValidationForm = (props) => {
  ...
  return (
    ...
    {/* <FileUpload/>   */}
      <div>
        <ButtonsPopupFooter type="submit" onClick = {props.click} disabled={submitting}>Сохранить</ButtonsPopupFooter>
        <ButtonsPopupFooter type="button" disabled={pristine || submitting} onClick={reset}>Очистить</ButtonsPopupFooter>
      </div>
    </form>
  )
}
