...
const Book = ({id, title, author, className, onDeleteButtonClick, onDoubleClick}) => (
        <CardContainer className="book-card">
            <Image className = {className} alt = {className}/>
            <CardContent>
                ...
                <CardInfo className="book-card__info">
                    ...
                    <BtnContainer>
                        {/* <BtnAbout type="button" onClick={onDoubleClick}>Редактировать</BtnAbout> */}
                        <BtnDelete type="button" onClick={onDeleteButtonClick}>Удалить</BtnDelete>
                        <BtnAbout type="button" >Редактировать</BtnAbout>
                    </BtnContainer>    
                </CardInfo>
            </CardContent>    
        </CardContainer>
